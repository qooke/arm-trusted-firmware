...
- ``ERRATA_A57_817171``: This applies erratum 817171 workaround to Cortex-A57
   CPU. This needs to be enabled for revisions r0p0, r0p1 of the CPU. It is fixed
   in r1p0.
...
- ``ERRATA_A57_836019``: This applies erratum 836019 workaround to Cortex-A57
   CPU. This needs to be enabled for revisions r0p0, r0p1, r1p0, r1p1, r1p2, r1p3
...
- ``ERRATA_A76_2356586``: This applies erratum 2356586 workaround to Cortex-A76
   CPU. This needs to be enabled for revisions r0p0, r1p0, r2p0, r3p0, r3p1, r4p0,
   r4p1 of the CPU. It is still open.
...
- ``ERRATA_A76_3888013``: This applies erratum 3888013 workaround to Cortex-A76
   CPU. This needs to be enabled for revisions r0p0, r1p0, r2p0, r3p0, r3p1, r4p0,
   r4p1 of the CPU. It is still open.
...
- ``ERRATA_A77_1220737``: This applies erratum 1220737 workaround to Cortex-A77
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r1p0.

- ``ERRATA_A77_1253791``: This applies erratum 1253791 workaround to Cortex-A77
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r1p0.

- ``ERRATA_A77_1273521``: This applies erratum 1273521 workaround to Cortex-A77
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r1p0.

-  ``ERRATA_A77_1508412``: This applies errata 1508412 workaround to Cortex-A77
   CPU. This needs to be enabled only for revision <= r1p0 of the CPU.

- ``ERRATA_A77_1515815``: This applies erratum 1515815 workaround to Cortex-A77
...
- ``ERRATA_A77_3888015``: This applies erratum 3888015 workaround to Cortex-A77
   CPU. This needs to be enabled for revisions r0p0, r1p0, r1p1 of the CPU. It is
   still open.

For Cortex-A78, the following errata build flags are defined :

- ``ERRATA_A78_1467580``: This applies erratum 1467580 workaround to Cortex-A78
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.

- ``ERRATA_A78_1479939``: This applies erratum 1479939 workaround to Cortex-A78
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.

- ``ERRATA_A78_1492189``: This applies erratum 1492189 workaround to Cortex-A78
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.

- ``ERRATA_A78_1503072``: This applies erratum 1503072 workaround to Cortex-A78
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.

- ``ERRATA_A78_1515634``: This applies erratum 1515634 workaround to Cortex-A78
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.
...
- ``ERRATA_A78_1827429``: This applies erratum 1827429 workaround to Cortex-A78
   CPU. This needs to be enabled for revisions r0p0, r1p0 of the CPU. It is fixed
   in r1p1.
...
- ``ERRATA_A78_3888017``: This applies erratum 3888017 workaround to Cortex-A78
   CPU. This needs to be enabled for revisions r0p0, r1p0, r1p1, r1p2 of the CPU.
   It is still open.

- ``ERRATA_A78_4302972``: This applies erratum 4302972 workaround to Cortex-A78
   CPU. This needs to be enabled for revisions r0p0, r1p0, r1p1, r1p2 of the CPU.
   It is still open.
...
- ``ERRATA_A78C_1941499``: This applies erratum 1941499 workaround to
   Cortex-A78C CPU. This needs to be enabled for revision r0p0 of the CPU. It is
   fixed in r0p1.

- ``ERRATA_A78C_1951501``: This applies erratum 1951501 workaround to
   Cortex-A78C CPU. This needs to be enabled for revision r0p0 of the CPU. It is
   fixed in r0p1.
...
- ``ERRATA_A78C_2376746``: This applies erratum 2376746 workaround to
...
- ``ERRATA_A78C_2395407``: This applies erratum 2395407 workaround to
   Cortex-A78C CPU. This needs to be enabled for revisions r0p0, r0p1, r0p2 of the
   CPU. It is still open.
...
- ``ERRATA_A78C_2478780``: This applies erratum 2478780 workaround to
   Cortex-A78C CPU. This needs to be enabled for revisions r0p0, r0p1, r0p2 of the
   CPU. It is still open.
...
- ``ERRATA_A78C_2779483``: This applies erratum 2779483 workaround to
   Cortex-A78C CPU. This needs to be enabled for revisions r0p0, r0p1, r0p2 of the
   CPU. It is still open.
...
- ``ERRATA_A78C_4302974``: This applies erratum 4302974 workaround to
   Cortex-A78C CPU. This needs to be enabled for revisions r0p0, r0p1, r0p2 of the
   CPU. It is still open.

For Cortex-X1 CPU, the following errata build flags are defined:

- ``ERRATA_X1_1467580``: This applies erratum 1467580 workaround to Cortex-X1
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.

- ``ERRATA_X1_1492189``: This applies erratum 1492189 workaround to Cortex-X1
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.

- ``ERRATA_X1_1503072``: This applies erratum 1503072 workaround to Cortex-X1
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.

- ``ERRATA_X1_1515634``: This applies erratum 1515634 workaround to Cortex-X1
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.

- ``ERRATA_X1_1479939``: This applies erratum 1479939 workaround to Cortex-X1
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.
...
- ``ERRATA_X1_1941498``: This applies erratum 1941498 workaround to Cortex-X1
   CPU. This needs to be enabled for revisions r0p0, r1p0, r1p1 of the CPU. It is
   fixed in r1p2.

- ``ERRATA_X1_1951500``: This applies erratum 1951500 workaround to Cortex-X1
   CPU. This needs to be enabled for revisions r0p0, r1p0, r1p1 of the CPU. It is
   fixed in r1p2.

- ``ERRATA_X1_1952683``: This applies erratum 1952683 workaround to Cortex-X1
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r1p0.

- ``ERRATA_X1_2376745``: This applies erratum 2376745 workaround to Cortex-X1
   CPU. This needs to be enabled for revisions r0p0, r1p0, r1p1, r1p2 of the CPU.
   It is still open.

- ``ERRATA_X1_2395406``: This applies erratum 2395406 workaround to Cortex-X1
   CPU. This needs to be enabled for revisions r0p0, r1p0, r1p1, r1p2 of the CPU.
   It is still open.

- ``ERRATA_X1_2742426``: This applies erratum 2742426 workaround to Cortex-X1
   CPU. This needs to be enabled for revisions r0p0, r1p0, r1p1, r1p2 of the CPU.
   It is still open.

- ``ERRATA_X1_2779479``: This applies erratum 2779479 workaround to Cortex-X1
   CPU. This needs to be enabled for revisions r0p0, r1p0, r1p1, r1p2 of the CPU.
   It is still open.

- ``ERRATA_X1_3888017``: This applies erratum 3888017 workaround to Cortex-X1
   CPU. This needs to be enabled for revisions r0p0, r1p0, r1p1, r1p2 of the CPU.
   It is still open.
...
- ``ERRATA_N1_3888013``: This applies erratum 3888013 workaround to Neoverse N1
   CPU. This needs to be enabled for revisions r0p0, r1p0, r2p0, r3p0, r3p1, r4p0,
   r4p1 of the CPU. It is still open.

For Neoverse V1, the following errata build flags are defined :

- ``ERRATA_V1_1542436``: This applies erratum 1542436 workaround to Neoverse V1
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.

- ``ERRATA_V1_1618634``: This applies erratum 1618634 workaround to Neoverse V1
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.
...
- ``ERRATA_V1_1618636``: This applies erratum 1618636 workaround to Neoverse V1
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.

- ``ERRATA_V1_1619807``: This applies erratum 1619807 workaround to Neoverse V1
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.

- ``ERRATA_V1_1654562``: This applies erratum 1654562 workaround to Neoverse V1
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.

- ``ERRATA_V1_1674403``: This applies erratum 1674403 workaround to Neoverse V1
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed
   in r1p0.
...
- ``ERRATA_V1_3888016``: This applies erratum 3888016 workaround to Neoverse V1
   CPU. This needs to be enabled for revisions r0p0, r1p0, r1p1, r1p2 of the CPU.
   It is still open.
...
- ``ERRATA_A710_1785648``: This applies erratum 1785648 workaround to
...
- ``ERRATA_A710_1847092``: This applies erratum 1847092 workaround to
   Cortex-A710 CPU. This needs to be enabled for revision r0p0 of the CPU. It is
   fixed in r1p0.

- ``ERRATA_A710_1887102``: This applies erratum 1887102 workaround to
   Cortex-A710 CPU. This needs to be enabled for revisions r0p0, r1p0 of the CPU.
   It is fixed in r2p0.
...
- ``ERRATA_A710_4302969``: This applies erratum 4302969 workaround to
   Cortex-A710 CPU. This needs to be enabled for revisions r0p0, r1p0, r2p0, r2p1
   of the CPU. It is still open.
...
- ``ERRATA_X2_1785648``: This applies erratum 1785648 workaround to Cortex-X2
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r1p0.

- ``ERRATA_X2_1793423``: This applies erratum 1793423 workaround to Cortex-X2
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r1p0.

- ``ERRATA_X2_1863568``: This applies erratum 1863568 workaround to Cortex-X2
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r1p0.

- ``ERRATA_X2_1887102``: This applies erratum 1887102 workaround to Cortex-X2
   CPU. This needs to be enabled for revisions r0p0, r1p0 of the CPU. It is fixed
   in r2p0.
...
- ``ERRATA_X3_2138930``: This applies erratum 2138930 workaround to Cortex-X3
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r1p0.

- ``ERRATA_X3_2147714``: This applies erratum 2147714 workaround to Cortex-X3
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r1p0.

- ``ERRATA_X3_2184829``: This applies erratum 2184829 workaround to Cortex-X3
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r1p0.

- ``ERRATA_X3_2214778``: This applies erratum 2214778 workaround to Cortex-X3
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r1p0.
...
- ``ERRATA_X4_2620954``: This applies erratum 2620954 workaround to Cortex-X4
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r0p1.

- ``ERRATA_X4_2631888``: This applies erratum 2631888 workaround to Cortex-X4
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r0p1.

- ``ERRATA_X4_2646977``: This applies erratum 2646977 workaround to Cortex-X4
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r0p1.
...
- ``ERRATA_X4_3841338``: This applies erratum 3841338 workaround to Cortex-X4
   CPU. This needs to be enabled for revision r0p0 of the CPU. It is fixed in r0p1.
...
- ``ERRATA_A715_2238661``: This applies erratum 2238661 workaround to
   Cortex-A715 CPU. This needs to be enabled for revision r0p0 of the CPU. It is
   fixed in r1p0.

- ``ERRATA_A715_2239006``: This applies erratum 2239006 workaround to
   Cortex-A715 CPU. This needs to be enabled for revision r0p0 of the CPU. It is
   fixed in r1p0.

- ``ERRATA_A715_2275754``: This applies erratum 2275754 workaround to
   Cortex-A715 CPU. This needs to be enabled for revision r0p0 of the CPU. It is
   fixed in r1p0.

- ``ERRATA_A715_2284544``: This applies erratum 2284544 workaround to
   Cortex-A715 CPU. This needs to be enabled for revision r0p0 of the CPU. It is
   fixed in r1p0.

- ``ERRATA_A715_2285473``: This applies erratum 2285473 workaround to
   Cortex-A715 CPU. This needs to be enabled for revision r0p0 of the CPU. It is
   fixed in r1p0.

- ``ERRATA_A715_2292761``: This applies erratum 2292761 workaround to
   Cortex-A715 CPU. This needs to be enabled for revision r0p0 of the CPU. It is
   fixed in r1p0.
...
- ``ERRATA_C1PRO_3684268``: This applies erratum 3684268 workaround to C1-Pro
   CPU. This needs to be enabled for revisions r0p0, r1p0 of the CPU. It is fixed
   in r1p1.
